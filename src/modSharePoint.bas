...
NextDataRow:
    ...
    SendJson paUrl, jsonBody, "SharePointアップロード完了"
End Sub
...
Public Sub UploadAllToSharePoint()
    ...
    Dim vProdCode  As Variant
    Dim vAmount    As Variant
    Dim vUnitPrice As Variant
    Dim vQty       As Variant
    Dim vDate      As Variant
    Dim vSaleType  As Variant
    Dim vDept      As Variant
    Dim vProdName  As Variant
    Dim vMargin    As Variant
    ...
    SendJson paUrl, jsonBody, "allシートSharePointアップロード完了: " & (lastRow - 1) & "行"
End Sub
...
Private Sub SendJson(paUrl As String, jsonBody As String, successMsg As String)
    ...
    If http.Status = 200 Or http.Status = 202 Then
        LogMessage successMsg & " (HTTP " & http.Status & ")"
    Else
